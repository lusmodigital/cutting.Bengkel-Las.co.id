...
- **Writer task:** Expand this file into one complete article answering: “Menentukan Ukuran Batch untuk Komponen Custom”
...
- **Primary intent:** Memilih jumlah produksi per batch
...
- **Scope boundary:** Fokus ukuran lot; dampak harga unit dimiliki CUT-12-05.
- **Final public route:** `/artikel/menentukan-ukuran-batch-komponen.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menentukan Ukuran Batch untuk Komponen Custom**.
...
- `CUT-14-03` → `/artikel/kontrol-revisi-file-cutting.html` — Cara Mencatat Revisi File agar Part Lama dan Baru Tidak Tertukar
- `CUT-14-05` → `/artikel/golden-sample-pesanan-cutting.html` — Menyimpan Golden Sample untuk Pesanan Cutting Berulang
- `CUT-14-06` → `/artikel/perubahan-desain-di-tengah-produksi.html` — Perubahan Desain di Tengah Produksi: Dampak pada Biaya dan Jadwal
...
- **Tie back to this article:** Keep the explanation specific to “Menentukan Ukuran Batch untuk Komponen Custom”.
