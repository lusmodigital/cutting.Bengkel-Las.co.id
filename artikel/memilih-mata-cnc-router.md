...
- **Writer task:** Expand this file into one complete article answering: “Memilih Mata Router untuk Kayu, MDF, Akrilik, dan ACP”
...
- **Primary intent:** Memilih jenis tool router menurut bahan
...
- **Scope boundary:** Fokus pemilihan cutter; parameter kualitas hasil dibahas terpisah.
- **Final public route:** `/artikel/memilih-mata-cnc-router.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Mata Router untuk Kayu, MDF, Akrilik, dan ACP**.
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Mata Router untuk Kayu, MDF, Akrilik, dan ACP”.
