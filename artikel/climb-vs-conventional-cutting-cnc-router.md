...
| Keausan dan panas | Dipengaruhi mata, material, kedalaman, dan feed (laju pemakanan); tidak ada jaminan universal | Dipengaruhi faktor yang sama; hasil perlu dibandingkan lewat sampel |

Tabel ini adalah kerangka keputusan, bukan resep parameter. Beban aktual berubah menurut diameter dan jumlah flute (alur pemotong), runout (oleng radial), kedalaman potong, feed (laju pemakanan), rpm, material, serta cara lembaran ditopang. **[NEEDS TECHNICAL REVIEW: operator dan penanggung jawab teknik harus mengonfirmasi rekomendasi arah serta parameter dari manual mesin, pembuat mata, dan prosedur bengkel.]**
