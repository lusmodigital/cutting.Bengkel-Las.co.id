...
- **Writer task:** Expand this file into one complete article answering: “Climb Cutting vs Conventional Cutting pada CNC Router”
...
- **Primary intent:** Memahami arah pemakanan router
...
- **Scope boundary:** Khusus arah toolpath; bukan panduan desain file umum.
- **Final public route:** `/artikel/climb-vs-conventional-cutting-cnc-router.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Climb Cutting vs Conventional Cutting pada CNC Router**.
...
- `CUT-05-01` → `/artikel/cara-kerja-cnc-router.html` — Cara Kerja CNC Router untuk Memotong dan Mengukir Panel
...
- **Tie back to this article:** Keep the explanation specific to “Climb Cutting vs Conventional Cutting pada CNC Router”.
