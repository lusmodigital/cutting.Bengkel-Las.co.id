...
- **Writer task:** Expand this file into one complete article answering: “Perubahan Desain di Tengah Produksi: Dampak pada Biaya dan Jadwal”
...
- **Primary intent:** Mengelola engineering change
...
- **Scope boundary:** Fokus dampak perubahan aktif; koordinasi vendor umum dimiliki CUT-16.
- **Final public route:** `/artikel/perubahan-desain-di-tengah-produksi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Perubahan Desain di Tengah Produksi: Dampak pada Biaya dan Jadwal**.
...
- **Tie back to this article:** Keep the explanation specific to “Perubahan Desain di Tengah Produksi: Dampak pada Biaya dan Jadwal”.
