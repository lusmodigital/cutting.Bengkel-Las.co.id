...
- **Writer task:** Expand this file into one complete article answering: “Mengatur Layer untuk Potong, Ukir, Pocket, dan Marking”
...
- **Primary intent:** Memisahkan operasi melalui layer
...
- **Scope boundary:** Memiliki struktur operasi file; warna visual dan desain produk bukan fokus.
- **Final public route:** `/artikel/mengatur-layer-file-cnc.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengatur Layer untuk Potong, Ukir, Pocket, dan Marking**.
...
- **Tie back to this article:** Keep the explanation specific to “Mengatur Layer untuk Potong, Ukir, Pocket, dan Marking”.
