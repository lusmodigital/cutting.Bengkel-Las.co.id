...
- **Writer task:** Expand this file into one complete article answering: “Tepi CNC Router Berserat, Pecah, atau Meleleh: Apa Penyebabnya?”
...
- **Primary intent:** Mendiagnosis cacat tepi router
...
- **Scope boundary:** Khusus router; cacat laser dan milling memiliki artikel sendiri.
- **Final public route:** `/artikel/cacat-tepi-cnc-router.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tepi CNC Router Berserat, Pecah, atau Meleleh: Apa Penyebabnya?**.
...
- **Tie back to this article:** Keep the explanation specific to “Tepi CNC Router Berserat, Pecah, atau Meleleh: Apa Penyebabnya?”.
