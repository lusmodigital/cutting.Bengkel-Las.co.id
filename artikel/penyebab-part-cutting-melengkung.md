...
- **Writer task:** Expand this file into one complete article answering: “Part Cutting Melengkung: Material, Panas, atau Urutan Potong?”
...
- **Primary intent:** Mendiagnosis distorsi part
...
- **Scope boundary:** Fokus deformasi; variasi material umum dimiliki CUT-07.
- **Final public route:** `/artikel/penyebab-part-cutting-melengkung.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Part Cutting Melengkung: Material, Panas, atau Urutan Potong?**.
...
- `CUT-11-06` → `/artikel/rework-atau-potong-ulang-part-cacat.html` — Rework atau Potong Ulang: Cara Memilih Penanganan Part Cacat
...
- **Tie back to this article:** Keep the explanation specific to “Part Cutting Melengkung: Material, Panas, atau Urutan Potong?”.
