...
date_modified: null
parent_topic: CUT-11
primary_intent: "Memilih tindakan setelah cacat ditemukan"
reader_community: "Bengkel-las.co.id"
reader_address: "Kawan Bengkel-las.co.id"
final_route: "/artikel/rework-atau-potong-ulang-part-cacat.html"
...
Substitution rule: do not replace this image; if unavailable or provenance is incomplete, use [NEEDS IMAGE REVIEW: LOCAL-005].
...
Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu. [Kembali ke halaman utama Bengkel-las.co.id](/) atau [buka aset lokal](/wp-content/uploads/2019/10/bengkel-las.png).
...
1. **Verifikasi dokumen.** Cocokkan gambar, revisi, material, joint identity, toleransi, dan instruksi kerja. Tandai bagian yang hilang sebagai [NEEDS CONTROLLED DRAWING, REVISION, OR PROCEDURE].
