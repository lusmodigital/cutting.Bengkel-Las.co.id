...
- **Writer task:** Expand this file into one complete article answering: “Dasar Nesting untuk Menghemat Material Lembaran”
...
- **Primary intent:** Memahami tata letak part pada lembaran
...
- **Scope boundary:** Fondasi nesting; rincian harga material dimiliki CUT-12.
- **Final public route:** `/artikel/dasar-nesting-material-lembaran.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dasar Nesting untuk Menghemat Material Lembaran**.
...
- **Tie back to this article:** Keep the explanation specific to “Dasar Nesting untuk Menghemat Material Lembaran”.
